...
public class SharingPostAdapter extends RecyclerView.Adapter<SharingPostAdapter.ViewHolder>{
    private List<KnowledgeSharing> knowledgeSharings;
    private Context context;

    public SharingPostAdapter(Context applicationContext, List<KnowledgeSharing> sharingArrayList) {
        this.context =applicationContext;
        this.knowledgeSharings=sharingArrayList;
    }

    @Override
    public SharingPostAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.row_sharing, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(SharingPostAdapter.ViewHolder viewHolder, int i) {
