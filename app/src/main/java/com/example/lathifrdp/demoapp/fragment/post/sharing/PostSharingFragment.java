...
public class PostSharingFragment extends Fragment{
...
//        pd.show();
    ...
    private void loadKnowledge() {
        ...
        try {
            ...
            Call<SharingResponse> call = apiService.getKnowledgePost("JWT "+ sessionManager.getKeyToken(),createdBy,limit);
            call.enqueue(new Callback<SharingResponse>() {
                ...
                public void onResponse(Call<SharingResponse> call, final Response<SharingResponse> response) {
                    if (response.isSuccessful()) {
                        ...
                        recyclerView.setAdapter(new SharingPostAdapter(getActivity(), sharingArrayList));
                        recyclerView.smoothScrollToPosition(0);
