...
import com.example.lathifrdp.demoapp.adapter.CrowdMahasiswaPostList;
...
public class PostCrowdFragment extends Fragment {
    private String title;
    TextView tv;
    SwipeRefreshLayout mSwipeRefreshLayout;
    ListView listView;
    CrowdMahasiswaPostList adapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_post_crowd,null);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter= new CrowdMahasiswaPostList(listCrowd,getActivity());
