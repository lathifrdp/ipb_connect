...
public class CrowdMProgressFragment extends Fragment {
    ...
    public static CrowdMProgressFragment newInstance(String id) {

        Bundle args = new Bundle();
        CrowdMProgressFragment fragment = new CrowdMProgressFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_crowd_progress_mahasiswa,null);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        listView=(ListView)getView().findViewById(R.id.listProgressMahasiswa);
